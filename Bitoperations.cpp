...
int reverseBits(int n) {
    ...
    return b.to_ulong(); // Konvertieren des bitset zurück zu einem unsigned long
}
...
int main() {
    ...
    bitset<4> zahl1{0b0111};
    bitset<4> zahl2{0b0011};
    zahl2.flip();
    zahl2 |= 1;
    cout << zahl2 << endl;
    zahl1=zahl1.to_ulong()*-1;
    cout << zahl1.to_string() << endl;

    cout << countLeadingZeros(1) << endl;
    cout << countSetBitsInRange(29, 0, 3);
    return 0;
}
